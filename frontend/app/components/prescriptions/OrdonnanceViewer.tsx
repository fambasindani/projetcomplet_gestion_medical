...
export default function OrdonnanceViewer({ isOpen, prescriptionId, onClose }: Props) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          {loading ? (
            ...
            <div className="p-6 text-center">Impossible de charger la prescription</div>
          )}
        </div>
        <div className="p-4 border-t flex justify-end">
          <button onClick={onClose} className="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg">Fermer</button>
        </div>
      </div>
    </div>
  );
