...
const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-4 rounded-lg border-t border-slate-200 bg-white px-4 py-3 sm:flex-row sm:px-6">
      {/* Info text */}
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="rounded-md border border-gray-300 p-2 text-gray-500 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
        >
